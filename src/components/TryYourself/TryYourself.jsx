    ...
    <div className="relative">
      <div className=" bg-tryYourselfbg bg-cover w-full  pt-20 text-white ">
        <div className="flex flex-col items-center gap-20">
          <h2 className="text-5xl font-bold">LIFE THE WAY YOU WANT IT</h2>
          <p className="text-3xl font-semibold w-1/2 text-center">
          ...
          <div className="flex w-3/5 mx-auto relative justify-center">
            <img
              src={frontman}
              className="absolute animated bounce transition delay-150 duration-300"
              alt=""
            />
